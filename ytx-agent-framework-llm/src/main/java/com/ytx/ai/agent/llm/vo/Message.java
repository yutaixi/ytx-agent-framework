...
public class Message {
    ...
    public static Message ofSystem(String content) {
        ...
        return new Message(Message.Role.SYSTEM.getValue(), content);
    }

    public static Message ofAssistant(String content) {

        return new Message(Message.Role.ASSISTANT.getValue(), content);
    }

    public static Message ofFunction(String function) {

        return new Message(Message.Role.FUNCTION.getValue(), function);
    }
