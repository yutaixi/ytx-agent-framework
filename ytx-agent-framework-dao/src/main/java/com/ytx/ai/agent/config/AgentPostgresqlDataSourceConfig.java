...
@ConditionalOnProperty(name = "ai.agent.repository.type", havingValue = RepositoryType.TYPE_POSTGRESQL, matchIfMissing = false)
public class AgentPostgresqlDataSourceConfig {
